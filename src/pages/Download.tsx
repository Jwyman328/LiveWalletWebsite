  ...
  return (
    <div className="pt-10 flex flex-col items-center w-full bg-gray-100 w-full">
      <div className="flex flex-col">
        ...
        <p className="mt-4 font-semibold">Latest release: 0.5.0 </p>
        <DownloadsTable />
      </div>
    </div>
  );
  ...
  const versions = [
    {
      ...
      label: "0.5.0-arm64.dmg",
      link: "https://github.com/Jwyman328/LiveWallet/releases/download/0.5.0/Live.Wallet-0.5.0-arm64.dmg",
    },
    {
      type: "MacOS (Intel)",
      label: "0.5.0.dmg",
      link: "https://github.com/Jwyman328/LiveWallet/releases/download/0.5.0/Live.Wallet-0.5.0.dmg",
    },
  ];
