        ...
        <div className="flex-1 mr-12 mb-4">
          ...
          <div>
            ...
            <p>
              ...
              unspendable. Although it is not native to bitcoin another
              component of UTXO health that resonates with people is
              understanding the fiat price of spending a UTXO. Live Wallet
              allows users to adjust the Bitcoin price, helping them answer
              questions like: 'If I have to pay 3000 sats/vbyte and the Bitcoin
              price is $1,000,000, how much USD will it cost to spend one of my
              UTXOs?'" 
            </p>
          </div>
        </div>
